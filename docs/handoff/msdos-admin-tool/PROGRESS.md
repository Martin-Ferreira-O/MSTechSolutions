...
- 2026-06-23 18:39 — Claude Opus 4.8 (implement) — Paso 6: `m3_procesos` — lógica extraída a
  `listar/buscar/finalizar` (devuelven texto); `build_panel` con botón Listar, entry+Buscar y
